...
Create API's to do each of the following:
                    - get weather of London from http://api.openweathermap.org/data/2.5/weather?q=London&appid
                    http://api.openweathermap.org/data/2.5/forecast=<useYourOwnAppId>  (NOTE: must use HTTP infront of the url else axios will attempt to hit localhost and give error  ..also use HTTP only and not HTTPS)
...
https://cdn-api.co-vin.in/api​/v2​/appointment​/sessions​/public​/findByDistrict?district_id=364&date=27-04-2022